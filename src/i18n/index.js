...
export const translations = {
    sq: {
        ...
        currencyLastUpdated: (value) => `Përditësuar: ${value}`,
        fallbackRatesNotice: "Duke përdorur kurset rezervë",
        gross: "Bruto",
        net: "Neto",
        ...
        jobCards: {
            ...
            placeholderGross: "P.sh. 120000 bruto",
            placeholderNet: "P.sh. 95000 neto",
            modeLabel: "Zgjidh mënyrën e llogaritjes",
            currentModeGross: "Duke futur pagën bruto",
            currentModeNet: "Duke futur pagën neto",
            workingDays: "Ditë pune në muaj",
            ...
            summaryGrossInput: "Paga Bruto (e futur)",
            summaryGrossCalculated: "Paga Bruto (e llogaritur)",
            summaryDeductions: "Totali i zbritjeve",
            summaryNet: "Paga Neto",
            summaryNetInput: "Paga Neto (e futur)",
            summaryNetCalculated: "Paga Neto (e llogaritur)",
        ...
        totalMonthlyCard: {
            ...
            grossBack: "Shuma bruto mujore nga të gjitha kontratat aktive.",
            deductionsBack: "Kontribute, TAP dhe pensioni vullnetar të përmbledhura.",
            netBack: "Paga neto mujore që merrni në dorë pas zbritjeve.",
            employerBack: "Kosto mujore që punëdhënësi paguan për ju.",
            flipHint: "Kliko ose shtyp space për shpjegimin",
            flipBackHint: "Kthehu tek vlera mujore",
...
`
    ...
    en: {
        ...
        currencyLastUpdated: (value) => `Last updated: ${value}`,
        fallbackRatesNotice: "Using fallback rates",
        gross: "Gross",
        net: "Net",
        ...
        jobCards: {
            ...
            placeholderGross: "e.g. 120000 gross",
            placeholderNet: "e.g. 95000 net",
            modeLabel: "Calculation mode",
            currentModeGross: "Currently entering gross salary",
            currentModeNet: "Currently entering net salary",
            workingDays: "Working days per month",
            ...
            summaryGrossInput: "Gross pay (entered)",
            summaryGrossCalculated: "Gross pay (calculated)",
            summaryDeductions: "Total deductions",
            summaryNet: "Net pay",
            summaryNetInput: "Net pay (entered)",
            summaryNetCalculated: "Net pay (calculated)",
        ...
        totalMonthlyCard: {
            ...
            grossBack: "Monthly gross pay across every active contract.",
            deductionsBack: "Combined employee contributions, TAP tax and voluntary pension.",
            netBack: "Take-home pay after all deductions.",
            employerBack: "Total monthly employer cost for your contracts.",
            flipHint: "Tap or press space to read the explainer",
            flipBackHint: "Return to the monthly value",
...
`
    ...
    it: {
        ...
        currencyLastUpdated: (value) => `Ultimo aggiornamento: ${value}`,
        fallbackRatesNotice: "Utilizzo tassi di riserva",
        gross: "Lordo",
        net: "Netto",
        ...
        jobCards: {
            ...
            placeholderGross: "Es. 120000 lordo",
            placeholderNet: "Es. 95000 netto",
            modeLabel: "Modalità di calcolo",
            currentModeGross: "Inserendo attualmente lo stipendio lordo",
            currentModeNet: "Inserendo attualmente lo stipendio netto",
            workingDays: "Giorni lavorativi al mese",
            ...
            summaryGrossInput: "Retribuzione lorda (inserita)",
            summaryGrossCalculated: "Retribuzione lorda (calcolata)",
            summaryDeductions: "Totale trattenute",
            summaryNet: "Retribuzione netta",
            summaryNetInput: "Retribuzione netta (inserita)",
            summaryNetCalculated: "Retribuzione netta (calcolata)",
        ...
        totalMonthlyCard: {
            ...
            grossBack: "Retribuzione lorda mensile complessiva di tutti i contratti.",
            deductionsBack: "Somma di contributi, TAP e pensione volontaria.",
            netBack: "Compenso netto mensile dopo tutte le trattenute.",
            employerBack: "Costo mensile totale a carico dell'azienda.",
            flipHint: "Tocca o premi spazio per leggere la spiegazione",
            flipBackHint: "Torna al valore mensile",
