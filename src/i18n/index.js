export const translations = {
    sq: {
        ...
        tapWarningTitle: "Paralajmërim TAP 2025",
        ...
        jobSelectorTitle: "Skema e punësimeve",
        jobSelectorSubtitle: "Simuloni një punë të vetme ose kombinime me deri në tre kontrata.",
        jobSelectorSingle: "Punë e vetme",
        jobSelectorMultiple: "2–3 punë",
        ...
        childDeductionLabel: "Zbritja mujore për fëmijët në ngarkim",
        childDeductionTooltip: "Shkruani shumën mujore të miratuar nga administrata tatimore për zbritjen familjare.",
        voluntaryPensionLabel: "Kontributet vullnetare në pension",
        voluntaryPensionTooltip: "Maksimumi i zbritshëm është 40,000 ALL në muaj. Kjo shtohet mbi kontributet e detyrueshme.",
        voluntaryPensionCapWarning: "Shuma e kontributit vullnetar nuk mund të kalojë {cap} në muaj.",
        ...
        secondaryToggleLabel: "Gjendja e kësaj pune",
        activateJob: "Aktivizo",
        deactivateJob: "Çaktivizo",
        secondaryJobDisabled: "Kjo punë nuk është duke u llogaritur aktualisht. Aktivizojeni për të shtuar të ardhurat shtesë.",
        expandCard: "Hap kartën",
        collapseCard: "Mbyll kartën",
        jobRole_primary: "Puna kryesore",
        jobRoleBadge_primary: "Primare",
        jobRoleDescription_primary: "Kjo është punësimi juaj kryesor ku zbatohet TAP progresiv.",
        jobRole_secondary: "Puna shtesë",
        jobRoleBadge_secondary: "Sekondare",
        jobRoleDescription_secondary: "Kontratat e dyta paguajnë vetëm kontributet; TAP nuk aplikohet këtu.",
        jobRole_tertiary: "Puna e tretë",
        jobRoleBadge_tertiary: "Terciare",
        jobRoleDescription_tertiary: "Përdoreni për projekte të treta ose të ardhura sporadike.",
        tryExamplesTitle: "Provo skenarët e vitit 2025",
        examplesSingleTechLabel: "Shembull: Inxhinier kryesor (bruto 145k)",
        examplesSingleTechDescription: "Paga e vetme mujore me fokus në TAP-in progresiv.",
        examplesDualEducatorLabel: "Shembull: Mësues + kurs online",
        examplesDualEducatorDescription: "Paga kryesore neto 82k dhe kontratë e dytë 45k bruto me zbritje familjare.",
        examplesTripleHealthcareLabel: "Shembull: Profesionist shëndetësor me 3 kontrata",
        examplesTripleHealthcareDescription: "Tre burime të ardhurash dhe kontribut vullnetar pranë kufirit.",
        totalMonthlySummary: "Përmbledhja mujore totale",
        totalMonthlyDescription: "Shuma e kombinuar e pagave bruto, neto dhe kostos së punëdhënësit në të gjitha punët.",
        pensionBaseCapAlert: "Baza e kontributeve ka arritur kufirin ligjor prej {limit}.",
    ...
    en: {
        ...
        tapWarningTitle: "2025 TAP Warning",
        ...
        jobSelectorTitle: "Employment setup",
        jobSelectorSubtitle: "Simulate a single job or combine up to three contracts.",
        jobSelectorSingle: "Single job",
        jobSelectorMultiple: "2–3 jobs",
        ...
        childDeductionLabel: "Monthly child allowance deduction",
        childDeductionTooltip: "Enter the monthly deduction approved by the tax administration for dependent children.",
        voluntaryPensionLabel: "Voluntary pension contributions",
        voluntaryPensionTooltip: "The deductible maximum is 40,000 ALL per month. This is on top of mandatory contributions.",
        voluntaryPensionCapWarning: "Voluntary pension cannot exceed {cap} per month.",
        ...
        secondaryToggleLabel: "Status of this job",
        activateJob: "Activate",
        deactivateJob: "Deactivate",
        secondaryJobDisabled: "This job is currently excluded. Activate it to include additional income.",
        expandCard: "Expand card",
        collapseCard: "Collapse card",
        jobRole_primary: "Primary job",
        jobRoleBadge_primary: "Primary",
        jobRoleDescription_primary: "Main employment where the progressive TAP applies.",
        jobRole_secondary: "Secondary job",
        jobRoleBadge_secondary: "Secondary",
        jobRoleDescription_secondary: "Additional contracts pay only contributions; TAP is not applied.",
        jobRole_tertiary: "Tertiary job",
        jobRoleBadge_tertiary: "Tertiary",
        jobRoleDescription_tertiary: "Use this slot for side projects or sporadic income.",
        tryExamplesTitle: "Try the 2025 scenarios",
        examplesSingleTechLabel: "Example: Lead engineer (145k gross)",
        examplesSingleTechDescription: "Single monthly salary focusing on the progressive TAP.",
        examplesDualEducatorLabel: "Example: Teacher + online course",
        examplesDualEducatorDescription: "Primary net salary 82k and secondary 45k gross with family deduction.",
        examplesTripleHealthcareLabel: "Example: Healthcare pro with 3 contracts",
        examplesTripleHealthcareDescription: "Three income streams and voluntary pension near the cap.",
        totalMonthlySummary: "Total monthly overview",
        totalMonthlyDescription: "Combined gross, net, deductions, and employer cost across all jobs.",
        pensionBaseCapAlert: "Contribution base has reached the legal ceiling of {limit}.",
    ...
    it: {
        ...
        tapWarningTitle: "Avviso TAP 2025",
        ...
        jobSelectorTitle: "Configurazione del lavoro",
        jobSelectorSubtitle: "Simula un solo lavoro oppure combina fino a tre contratti.",
        jobSelectorSingle: "Lavoro singolo",
        jobSelectorMultiple: "2–3 lavori",
        ...
        childDeductionLabel: "Detrazione mensile per figli a carico",
        childDeductionTooltip: "Inserisci la detrazione mensile approvata dall'amministrazione fiscale per i figli a carico.",
        voluntaryPensionLabel: "Contributi pensionistici volontari",
        voluntaryPensionTooltip: "Il massimo deducibile è 40.000 ALL al mese. Si aggiunge ai contributi obbligatori.",
        voluntaryPensionCapWarning: "Il contributo volontario non può superare {cap} al mese.",
        ...
        secondaryToggleLabel: "Stato di questo lavoro",
        activateJob: "Attiva",
        deactivateJob: "Disattiva",
        secondaryJobDisabled: "Questo lavoro è attualmente escluso. Attivalo per includere redditi aggiuntivi.",
        expandCard: "Apri scheda",
        collapseCard: "Chiudi scheda",
        jobRole_primary: "Lavoro principale",
        jobRoleBadge_primary: "Primario",
        jobRoleDescription_primary: "Impiego principale su cui si applica il TAP progressivo.",
        jobRole_secondary: "Lavoro secondario",
        jobRoleBadge_secondary: "Secondario",
        jobRoleDescription_secondary: "I contratti aggiuntivi versano solo i contributi; il TAP non si applica.",
        jobRole_tertiary: "Lavoro terziario",
        jobRoleBadge_tertiary: "Terziario",
        jobRoleDescription_tertiary: "Usalo per progetti extra o redditi saltuari.",
        tryExamplesTitle: "Prova gli scenari 2025",
        examplesSingleTechLabel: "Esempio: Ingegnere lead (145k lordo)",
        examplesSingleTechDescription: "Stipendio mensile singolo con focus sul TAP progressivo.",
        examplesDualEducatorLabel: "Esempio: Docente + corso online",
        examplesDualEducatorDescription: "Stipendio principale netto 82k e secondo contratto 45k lordo con detrazione familiare.",
        examplesTripleHealthcareLabel: "Esempio: Professionista sanitario con 3 contratti",
        examplesTripleHealthcareDescription: "Tre fonti di reddito e contributo volontario vicino al massimale.",
        totalMonthlySummary: "Panoramica mensile totale",
        totalMonthlyDescription: "Totale lordo, netto, trattenute e costo datore di lavoro su tutti i lavori.",
        pensionBaseCapAlert: "La base contributiva ha raggiunto il massimale legale di {limit}.",
